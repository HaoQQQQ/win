      ...
      <div className="container">
        ...
        <div className="row justify-content-between">
          ...
          <div className="d-flex subtitle-Block">
            ...
            <div className="customer-rate d-flex">
              <div className="total-rate-Number"><p>4.1</p></div>
            ...
            <p>詳細地址: 205 台灣省台中市北屯區大鵬路陳平里１２之３巷５之１弄３之２鄰５８號６樓之３</p>
            <p>訂房須知:※ 住宿日前3日內不得延期(除人力不可抗拒因素外), 延期訂金保留3個月(僅限延期一次)， 並請重新訂房，恕不另行通知。
            ※ 當日不接受退房,如欲更改帳型、人數、延期請於一週前通知。旅客於住宿日當天取消或怠於通知者沒收訂金總金額100 %。 旅客於住宿日前1天取消訂房扣訂金總金額80 %。</p>
        ...
        <div className="tentTextBlock col-4 align-self-center">
          <div className="text-align-center">
            <h3>手做聖誕吊飾</h3>
            <h5>目黑川是東京賞櫻景點很知名且排行前面的櫻花盛地，搭乘地鐵到中目黑站出站就可看到，每年會舉辦「目黑川櫻花季」（中目黑櫻花節）...</h5>
          </div>
        </div>
        <div className="col-2 align-self-center">
        ...
        <div className="tentTextBlock col-4 align-self-center">
          <div className="text-align-center">
            <h3>溫泉特區</h3>
            <h5>賞雪啦！每年一到了4-5月，就是全台油桐花的最佳季節，如白雪紛飛般的桐花遍佈整個台灣，除了賞花之外，還能體驗濃濃的客家氣息，這篇...</h5>
          </div>
        </div>
        <div className="col-2 align-self-center">
        <NumericInput min={0} max={4} value={1} mobile />
